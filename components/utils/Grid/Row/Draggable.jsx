...
class DraggableRow extends Component {
    ...
    render() {
        const {connectDragSource, children, item, sourceName, connectDragPreview, enableDragPreview, style, isDragging, ...props} = this.props;
...
export default DragSource('TableRow', spec, collect)(DraggableRow);
